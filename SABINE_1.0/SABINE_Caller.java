...
public class SABINE_Caller {
	...
	public void printCopyright() {
        ...
        //System.out.println("  Matlign. Copyright (C) 2007 Ari Loytynoja and Matti Kankainen. All rights reserved.");
	...
	public static void main(String[] args) {
		...
		for(int i=1; i<args.length-1; i+=2) {
			...
			if(args[i].equals("-s")) { caller.best_match_threshold	  		= Double.parseDouble (args[i+1]); 	continue; }
